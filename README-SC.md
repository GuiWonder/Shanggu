[正體中文](../../#shanggu-fonts-尙古字體) **简体中文**

# Shanggu Fonts 尙古字体
基于思源系列的传承字形（旧字形）CJK 字体家族系列

## 📌 概述
Shanggu Fonts（尙古字体） 是一套基于[思源黑体](https://github.com/adobe-fonts/source-han-sans)、[思源宋体](https://github.com/adobe-fonts/source-han-serif)与[思源等宽](https://github.com/adobe-fonts/source-han-mono)开发的 CJK 字体家族系列，以传承字形（旧字形）为核心理念的开源字体项目。字体系列涵盖黑体、明体与圆体等多种风格，并提供对应的简转体字体版本。
...
## 📝 命名
项目名称统一为“尙古（Shanggu）”。“尚”为“尙”的常用异体字，因此“尙古”亦常被写作“尚古”。本字体系列实际采用的中文名称为“尙古”。
...
中日简体字差异采用以下处理方式：<br />
- 中日简体字位于同一个 Unicode 码位时，使用不同的变体进行区分。<br />
![image](./pictures/pic0004.png)  
- 中日简体字位于不同 Unicode 码位时，遵循各自的书写规范，不作字形上的统一。<br />
